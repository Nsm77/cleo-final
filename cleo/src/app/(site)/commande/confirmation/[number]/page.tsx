    ...
    <div className="container-lux py-14 lg:py-20">
      ...
      <div className="mx-auto mt-14 grid max-w-4xl gap-10 lg:grid-cols-12">
        ...
        <div className="space-y-6 text-sm lg:col-span-5">
          ...
          <div className="flex flex-wrap gap-3"><Link href={trackingHref} className="btn-primary">Suivre ma commande</Link><Link href="/boutique" className="btn-secondary">Continuer</Link></div>
        </div>
      </div>
    </div>
  );
